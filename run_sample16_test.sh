...
#SBATCH --job-name=krill_s16_test
#SBATCH --output=krill_s16_test_%j.out
#SBATCH --error=krill_s16_test_%j.err
...
RUN_ID="Batch2_sample16_test"

# Input files stored inside WORK_DIR
SAMPLESHEET="${WORK_DIR}/batch2_sample16_test.csv"
...
OUTDIR="${WORK_DIR}/sample16_nextflow_test"

# Nextflow intermediate files
NXF_WORK_DIR="${WORK_DIR}/nextflow_work_sample16_test"
